...
public class RequestService implements IRequestService {
    ...
    private final IRequestRepositoryCustom iRequestRepositoryCustom;

    public RequestService(IUserService iUserService, IRequestRepository iRequestRepository, IRequestRepositoryCustom iRequestRepositoryCustom) {
        this.iUserService = iUserService;
        this.iRequestRepository = iRequestRepository;
        this.iRequestRepositoryCustom = iRequestRepositoryCustom;
    }
